...
const t: Record<'zh' | 'en', Translation> = {
  zh: {
    ...
    skills: [
      { name: 'zhicheng-shenbao-skill', tag: '申报助手', desc: '职称初定与评审申报全流程自动化，从材料梳理到提交清单。', stars: 1, url: 'https://github.com/Zaosusu/zhicheng-shenbao-skill' },
      { name: 'schedule-onepager-skill', tag: '效率工具', desc: '一页纸排期表，数据驱动生成 HTML 并直接渲染进邮箱。', stars: 0, url: 'https://github.com/Zaosusu/schedule-onepager-skill' },
      ...
      { name: 'resume-onepager-skill', tag: '简历', desc: '一页纸简历生成，输出带真实文字层的 A4 PDF / PNG。', stars: 0, url: 'https://github.com/Zaosusu/resume-onepager-skill' },
  ...
  en: {
    ...
    skills: [
      { name: 'zhicheng-shenbao-skill', tag: 'Filing Helper', desc: 'End-to-end automation for professional-title declaration & review, from material sorting to submission checklist.', stars: 1, url: 'https://github.com/Zaosusu/zhicheng-shenbao-skill' },
      { name: 'schedule-onepager-skill', tag: 'Productivity', desc: 'One-page schedule generator that renders HTML straight into your inbox.', stars: 0, url: 'https://github.com/Zaosusu/schedule-onepager-skill' },
      ...
      { name: 'resume-onepager-skill', tag: 'Resume', desc: 'One-page resume generator exporting A4 PDF / PNG with real text layers.', stars: 0, url: 'https://github.com/Zaosusu/resume-onepager-skill' },
