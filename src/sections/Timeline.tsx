...
const t = {
  zh: {
    ...
    items: [
      ...
      { year: '2019-2025', title: '财务自由', desc: 'ToB业务（MCN+供应商）爆发期，带来主要财富积累。股市验证周期理论，做到稳定盈利。' },
      { year: '2026', title: 'AI研究启动', desc: 'OpenGuitarChordProject立项。开始系统学习CS/数学/AI。准备2030考研' },
      { year: '2026-2030', title: '独立研究者之路', desc: '推进项目，发表论文。开源数据集和工具。考研获得学术资源。目标：成为能做深度研究的独立AI研究者' },
    ],
  },
  en: {
    title: 'The Transition',
    items: [
      { year: '2012–2022', title: 'Business Practice', desc: 'Film, MCN, e-commerce. Built up experience, but realized the fragility of people-dependent systems.' },
      ...
      { year: '2026–2030', title: 'Path to Independent Researcher', desc: 'Advance the project, publish papers, open-source datasets and tools. Goal: become a deep-research independent AI researcher.' },
    ],
  },
};
  ...
  return (
    <section id="timeline" className="bg-bg-secondary py-16 md:py-20 px-5">
      <div className="max-w-content mx-auto">
        <h2 className="font-noto font-bold text-xl md:text-2xl text-text-primary mb-10">{c.title}</h2>
